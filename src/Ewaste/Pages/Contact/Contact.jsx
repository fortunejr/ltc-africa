        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <li className="p-4 bg-white transition">
                <strong>HQ Office Nigeria:</strong>
                <br />
                4 Association Road, Governors Road Lagos
              </li>
              <li className="p-4 bg-white transition">
                <strong>Regional Office Madagascar:</strong>
                <br />Bat 49B II Afriport Warehouse, Antananarivo Madagascar
              </li>
              <li className="p-4 bg-white transition">
                <strong>Regional Facility:</strong>
                <br />Ghana , Botswana , Tanzania , Morocco ,South Africa.
              </li>
