...
const DataPolicy = () => {
  const sections = [
    {
      title: "1. Purpose",
      content: `The purpose of this policy is to outline how LTC Recycling Africa collects, processes, stores, and protects personal data in accordance with applicable data protection and privacy laws. LTC Recycling Africa is committed to ensuring that all personal information handled is used fairly, transparently, and securely.`,
    },
    {
      title: "2. Scope",
      list: [
        "Employees, contractors, and partners of LTC Recycling Africa.",
        "Clients, vendors, and third parties whose personal data we process.",
        "All operations, systems, and websites owned or managed by LTC Recycling Africa and its subsidiaries across Africa.",
      ],
    },
    {
    ...
    },
    {
      ...
      content: `LTC Recycling Africa may share personal data with trusted service providers, contractors, or partners who support our operations, and with government or regulatory authorities when legally required. All third parties must comply with LTC Recycling Africa’s data protection standards and confidentiality obligations. LTC Recycling Africa does not sell or rent personal data to any external party.`,
    },
    {
      title: "8. International Data Transfers",
      content: `Where data is transferred across borders, LTC Recycling Africa ensures appropriate data protection safeguards are in place, following relevant legal frameworks and international standards.`,
    },
    {
    ...
    },
    {
      ...
      list: [
        "Access their personal data held by LTC Recycling Africa.",
        ...
        "Requests can be made via privacy@ltcafrica.com",
      ],
    },
    {
      title: "11. Responsibilities",
      list: [
        "LTC Recycling Africa Management ensures compliance with this policy across all operations.",
    ...
    },
    {
      ...
      content: `This policy is reviewed annually or when significant changes occur in legal, operational, or technological frameworks. The latest version is always available at www.ltcafrica.com.`,
    },
  ];
    ...
    <FadeIn duration={120}>
      <section className="min-h-screen py-24 px-3 lg:px-20 bg-gray-50">
        <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-3xl p-6 lg:p-12 space-y-10">
          <h1 className="text-3xl lg:text-4xl font-bold text-customGreen text-center mb-12">
          ...
          {/* Contact Section */}
          <div className="mt-12 bg-gradient-to-br from-customGreen to-customGreen text-white p-8 rounded-2xl">
            <h2 className="text-3xl font-bold mb-3">
              Contact LTC Recycling Africa
            </h2>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:privacy@ltcafrica.com"
                  className="hover:underline"
                >
                  privacy@ltcafrica.com
                </a>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>LTC Recycling Africa</span>
              </li>
