  ...
  const sections = [
    {
      ...
      content: `This Cookies Policy explains how LTC Recycling Africa uses cookies and similar technologies on our website www.ltcfrica.com to improve your browsing experience, analyze site traffic, and ensure website functionality. By continuing to browse our site, you agree to the use of cookies as described in this policy.`,
    },
    {
    ...
    },
    {
      ...
      content: `LTC Recycling Africa may use trusted third-party services (e.g., Google Analytics) to monitor site performance. These third parties may also use cookies in accordance with their own privacy policies. LTC Recycling Africa does not control or manage third-party cookies directly.`,
    },
    {
      title: "6. Updates to This Policy",
      content: `LTC Recycling Africa may update this Cookies Policy periodically to reflect changes in technology or legal requirements. The latest version will always be available on our website, with the date of the last update indicated.`,
    },
  ];
    ...
    <FadeIn duration={120}>
      <section className="min-h-screen py-24 px-3 lg:px-20 bg-gray-50">
        <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-3xl p-6 lg:p-12 space-y-10">
          ...
          {/* Contact Section */}
          <div className="mt-12 bg-gradient-to-br from-customBlue to-customGreen text-white p-8 rounded-2xl">
            <h2 className="text-xl font-bold mb-3">Contact LTC Recycling Africa</h2>
